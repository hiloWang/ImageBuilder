...
public class FolderPopUpWindow extends PopupWindow implements View.OnClickListener {
  ...
  public FolderPopUpWindow(Context context, BaseAdapter adapter) {
    ...
    final View view = View.inflate(context, R.layout.__lakimage_pop_folder, null);
  ...
  private void enterAnimator() {
    ...
    ObjectAnimator translationY =
        ObjectAnimator.ofFloat(listView, "translationY", listView.getHeight(), 0);
  ...
  private void exitAnimator() {
    ...
    ObjectAnimator translationY =
        ObjectAnimator.ofFloat(listView, "translationY", 0, listView.getHeight());
    AnimatorSet set = new AnimatorSet();
    set.setDuration(300);
    set.playTogether(alpha, translationY);
    set.setInterpolator(new AccelerateDecelerateInterpolator());
