package com.lak.imagebuilder.widget;
...
public class CropImageView extends AppCompatImageView {
  ...
  public CropImageView(Context context, AttributeSet attrs, int defStyle) {
    ...
    mFocusWidth = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, mFocusWidth,
        getResources().getDisplayMetrics());
    mFocusHeight = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, mFocusHeight,
        getResources().getDisplayMetrics());
    mBorderWidth = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, mBorderWidth,
        getResources().getDisplayMetrics());

    TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.__lakimage_CropImageView);
    mMaskColor = a.getColor(R.styleable.__lakimage_CropImageView___lakimage_cropMaskColor, mMaskColor);
    mBorderColor = a.getColor(R.styleable.__lakimage_CropImageView___lakimage_cropBorderColor, mBorderColor);
    mBorderWidth =
        a.getDimensionPixelSize(R.styleable.__lakimage_CropImageView___lakimage_cropBorderWidth, mBorderWidth);
    mFocusWidth =
        a.getDimensionPixelSize(R.styleable.__lakimage_CropImageView___lakimage_cropFocusWidth, mFocusWidth);
    mFocusHeight =
        a.getDimensionPixelSize(R.styleable.__lakimage_CropImageView___lakimage_cropFocusHeight, mFocusHeight);
    mDefaultStyleIndex =
        a.getInteger(R.styleable.__lakimage_CropImageView___lakimage_cropStyle, mDefaultStyleIndex);
  ...
  private void initImage() {
    ...
    float transX = mFocusMidPoint.x - (mImageMatrixValues[2]
        + mImageWidth * mImageMatrixValues[0] / 2);  //X轴方向的位移
    float transY = mFocusMidPoint.y - (mImageMatrixValues[5]
        + mImageHeight * mImageMatrixValues[4] / 2); //Y轴方向的位移
  ...
  private Bitmap makeCropBitmap(Bitmap bitmap, RectF focusRect, RectF imageMatrixRect,
      int expectWidth, int exceptHeight, boolean isSaveRectangle) {
