package com.lak.imagebuilder.util;
...
public class NavigationBarChangeListener implements ViewTreeObserver.OnGlobalLayoutListener {
  ...
  @Override public void onGlobalLayout() {
    ...
    int navigationBarHeight =
        Utils.hasVirtualNavigationBar(rootView.getContext()) ? Utils.getNavigationBarHeight(
            rootView.getContext()) : 0;
  ...
  public static NavigationBarChangeListener with(View rootView, int orientation) {
    NavigationBarChangeListener changeListener =
        new NavigationBarChangeListener(rootView, orientation);
