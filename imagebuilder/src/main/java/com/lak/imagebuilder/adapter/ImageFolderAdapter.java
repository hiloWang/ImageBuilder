...
import com.lak.imagebuilder.util.AndroidLifecycleUtils;
...
public class ImageFolderAdapter extends BaseAdapter {
  ...
  @Override public ImageFolder getItem(int position) {
  ...
  @Override public View getView(int position, View convertView, ViewGroup parent) {
    ViewHolder holder;
    if (convertView == null) {
      convertView = mInflater.inflate(R.layout.__lakimage_adapter_folder_list_item, parent, false);
    ...
    holder.imageCount.setText(
        mActivity.getString(R.string.__lakimage_folder_image_count, folder.images.size()));

    //boolean canLoadImage = AndroidLifecycleUtils.canLoadImage(holder.cover.getContext());
